        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 ">
            <div className="flex flex-col gap-2 w-30 py-3 px-5 bg-slate-200 text-gray-600 rounded ">
              ...
              <p className="cursor-pointer hover:text-[#c586a5]">Logout</p>
            </div>
          </div>
        </div>
        <Link to="/cart" className=' relative '>
          <img src={assets.cart_icon} className='w-4 min-w-4'alt="" />
          <p className="absolute right-[-6px] bottom-[-6px] w-4 text-center bg-[#c586a5] rounded-full leading-4 aspect-square text-[8px]">10</p>
        </Link>
